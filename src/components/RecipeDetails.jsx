...
function RecipeDetails() {
  ...
  const peopleAlsoSee = (arr) => arr.sort(() => Math.random() - 0.5).slice(0, 5)

  const radomFive = peopleAlsoSee(recipe);

  return (
    <div className="flex flex-col gap-7 justify-center mt-20 bg-green-100 w-full h-full  p-5 md:p-[3rem] relative">
      ...
      <div className="flex flex-col gap-5">
        <div className="p-[1rem] text-2xl font-semibold border-green-400 border-1 rounded-lg">People Also Search</div>
